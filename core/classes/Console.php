...
class SZ_Console extends SZ_Driver implements Growable
{
	...
	{
		echo '============================================' . PHP_EOL;
		echo '  Seezoo-Framework Commnad Line Tool ver ' . DOGS_VERSION . PHP_EOL;
		echo '============================================' . PHP_EOL;
		echo 'usage: ' . PHP_EOL;
		echo '  Module Testing      : ./dog -t [model|library|class|helper|controller]' . PHP_EOL;
		echo '  Execute Script      : ./dog -r [pathinfo]' . PHP_EOL;
		echo '  Create Application  : ./dog -a ApplicationName' . PHP_EOL;
		echo '  Generate Module     : ./dog -g ' . PHP_EOL . PHP_EOL;
		exit;
	}
}
